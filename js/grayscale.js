...
$(function() {
    ...
    window.scrollTo(0, 0);
    // check if it has a set starting page in url
    ...
    // check if mobile and apply appropriate stylesheet
    // sources
    ...
    if (isMobile) {
      $('link[rel=stylesheet][href="css/desktop.css"]').remove();
    } else {
      $('link[rel=stylesheet][href="css/mobile.css"]').remove();
    }
